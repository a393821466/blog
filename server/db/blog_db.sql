...
CREATE TABLE IF NOT EXISTS `blog_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='评论' AUTO_INCREMENT=42 ;
...
(40, 21, 'maple', '-', '85029642@qq.com', 'js冒泡排序:\nvar a=[3,8,4,11];\nfunction sort(arr){\n   var max = arr.length - 1;\n   for(var i=0;i<max;i++){\n      var done=true;\n      for(var j=0;j<max-i;j++){\n         if(arr[j]>arr[j+1]){\n            var temp = arr[j];\n            arr[j]=arr[j+1];\n            arr[j+1] = temp;\n            done=false\n         }\n      }\n      if(done){\n        break;\n      }\n   }\n  return arr;\n}\nsort(a)\n执行结构:[3,4,8,11]\n', 39, 'http://localhost:3000//public/avatar/admin.jpg', '管理员', 1, 1580292104013),
(39, 21, '饿巍峨', '423213234', '12321@qq.com', '大选中茶多酚武器恶趣味请问请问萨达打撒是大大撒达到最大持续的高对方是否', 0, 'http://a0.att.hudong.com/16/12/01300535031999137270128786964.jpg', 'windows10', 1, 1580275394104),
...
(41, 20, 'maple', '-', '85029642@qq.com', '<pre>\n  var a=0;\n  console.log(a);\n</pre>', 27, 'http://localhost:3000//public/avatar/admin.jpg', '管理员', 1, 1580296802862);
