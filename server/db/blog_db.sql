...
CREATE TABLE IF NOT EXISTS `blog_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='评论' AUTO_INCREMENT=59 ;
...
(58, 21, '来来俩', '423213234', '12321@qq.com', '大选中茶多酚武器恶趣味请问请问萨达打撒是大大撒达到最大持续的高对方是否', 0, 'http://a0.att.hudong.com/16/12/01300535031999137270128786964.jpg', 'windows10', 2, 1580382272323),
(53, 20, 'maple', '-', '85029642@qq.com', '冒泡排序:<pre class="hl">\n  var a=[5,11,2,4];\n  function sort(arr){\n    var max=arr.length-1;\n    for(var i=0;i<max;i++){\n      var done=true;\n      for(var j=0;j<max-i;j++){\n        if(arr[j]>arr[j+1]){\n           var temp=arr[j];\n           arr[j]=arr[j+1];\n           arr[j+1]=temp;\n           done=false\n        }\n      }\n      if(done){\n        break;\n      }\n    }\n    return arr;\n  }\n  sort(a)\n</pre>\n\n运行结果为:[2,4,5,11]\n<span class="emoji-item-common emoji-grin emoji-size-small" ></span>', 27, 'http://localhost:3000//public/avatar/admin.jpg', '管理员', 1, 1580371907344);
...
INSERT INTO `blog_system` (`id`, `userId`, `title`, `summary`, `logo`, `logoImg`, `seo`) VALUES
(2, 9, '枫', '我的个人博客', '枫林木屋', 'http://localhost:3000/public/uploads/logo/2020/1580376726034194.jpeg', '前端免费视频第一博客');
